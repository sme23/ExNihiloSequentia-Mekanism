...
public class ExNihiloMekanismConfig {
    ...
    private static void oreConfigs() {
        enableOsmium = COMMON_BUILDER.comment("Enable osmium ore pieces, chunks and ingots if they exist. 'enableOreOverride' in the main Ex Nihilo config must be true for this to work. (Default: true)")
